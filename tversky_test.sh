...
echo 'RAW=' $nnUNet_raw
python -m main -i /home/bobby/repos/PDAC_Detection_forked/workspace/test/imagesTs/ -o /home/bobby/repos/PDAC_Detection_forked/workspace/test/labelsTs/tversky_predicted -m tversky_workspace/nnUNet_results
