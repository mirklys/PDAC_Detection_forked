                    ...
                    for plans in trainers[module]:
                        for r in results_dirs:
                            ...
                            if isdir(expected_output_folder):
                                ...
                                for fl in folds:
                                    expected_output_folder_fold = get_output_folder(
                                        d, module, plans, c, fl
                                    )
                                    expected_summary_file = join(
                                    ...
                                    if not isfile(expected_summary_file):
                                        ...
                                        foreground_mean = load_summary_json(
                                            expected_summary_file
            ...
            for pl in trainers[t]:
                ...
                for d in valid_configs.keys():
                    ...
                    for v in valid_configs[d]:
                        trainer_plan_d_config_locs = trainer_plan_d_locs & (
                            txt[:, 1] == v
                        )
                        if np.any(trainer_plan_d_config_locs):
                            ...
                            selected_row = txt[
                                np.argwhere(trainer_plan_d_config_locs)[0, 0]
                            ]
