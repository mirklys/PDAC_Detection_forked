...
class nnUNetTrainer_crossmoda(nnUNetTrainer):
    def __init__(
        self,
        plans: dict,
        configuration: str,
    ...
    def get_training_transforms(
        ...
        tr_transforms.append(TumorAugTransform(p_per_sample=0.1))
        tr_transforms.append(CochleaAugTransform(p_per_sample=0.1))
