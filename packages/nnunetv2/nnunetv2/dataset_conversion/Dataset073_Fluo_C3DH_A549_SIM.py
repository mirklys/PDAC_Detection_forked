...
if __name__ == "__main__":
    ...
    splits.append(
        {
            "train": [i for i in caseids if i.startswith("01_")],
            "val": [i for i in caseids if i.startswith("02_")],
        }
    )
    splits.append(
        {
            "train": [i for i in caseids if i.startswith("02_")],
            "val": [i for i in caseids if i.startswith("01_")],
        }
    )
