...
OUTPUT_DIR=/pct_wbo2/home/han.l/nnUNetMD/workspace/nnUNet_results/Dataset104_PANORAMA_baseline_PDAC_Detection/nnUNetTrainer_Loss_TVCE_checkpoints__nnUNetPlans_Res__3d_fullres
# EPOCHS=(final)
# FOLDS=(0 1 2 3 4)
FOLDS=(0)
...
for FOLD in "${FOLDS[@]}"; do
    for EPOCH in "${EPOCHS[@]}"; do
        nnUNetv2_predict -i ${IMAGE_DIR}/fold_${FOLD}/validation_images \
            ...
            -d 104 \
            -p nnUNetPlans_Res \
            -tr nnUNetTrainer_Loss_TVCE_checkpoints \
