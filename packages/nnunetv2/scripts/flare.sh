...
nnUNetv2_train 600 3d_fullres 0 -tr nnUNetTrainer_flare &

CUDA_VISIBLE_DEVICES=1
nnUNetv2_train 600 3d_fullres 1 -tr nnUNetTrainer_flare &

CUDA_VISIBLE_DEVICES=2
nnUNetv2_train 600 3d_fullres 2 -tr nnUNetTrainer_flare &

CUDA_VISIBLE_DEVICES=3
nnUNetv2_train 600 3d_fullres 3 -tr nnUNetTrainer_flare &
